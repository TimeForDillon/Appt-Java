...
/**
 * A monthly appointment class that is a subclass of the Appointment class
 */
public class MonthlyAppointment extends Appointment
{
    /**
     * Constructs an object of type MonthlyAppointment
     * @param month the month of the date
     * @param day the day of the date
     * @param year the year of the date
     * @param description the description of the appointment
     */
    MonthlyAppointment(int month, int day, int year, String description)
    {
    ...
    public boolean occursOn(int month, int day, int year)
    {
        ...
        {
            appointmentDate.increaseDate(0, 1);
    ...
    {
    	return super.toString() + "\rMONTHLY APPOINTMENT\r";
    }
}
